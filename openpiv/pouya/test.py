...
frame_a  = tools.imread( os.path.join(path,'./data/exp1_001_a.bmp'))
frame_b  = tools.imread( os.path.join(path,'./data/exp1_001_b.bmp'))
...
tools.save(x, y, u, v, mask, os.path.join(path,'./data/res.vec'))
tools.display_vector_field(os.path.join(path,'./data/res.vec'), scale=75, width=0.0035)